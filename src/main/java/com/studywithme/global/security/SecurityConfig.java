	...
	public SecurityFilterChain securityFilterChain(
		...
		http
			...
			.authorizeHttpRequests(authorize -> authorize
				...
				.requestMatchers(HttpMethod.GET, "/api/v1/studies", "/api/v1/studies/*").authenticated()
				.requestMatchers(HttpMethod.GET, "/api/v1/posts", "/api/v1/posts/*").authenticated()
				.requestMatchers(HttpMethod.GET, "/api/v1/posts/*/comments").authenticated()
				.requestMatchers(
					HttpMethod.POST,
					"/api/v1/studies",
					"/api/v1/studies/*/join",
