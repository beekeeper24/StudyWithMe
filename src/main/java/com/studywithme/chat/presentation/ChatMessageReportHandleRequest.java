...
public record ChatMessageReportHandleRequest(
	...
	public ChatMessageReportHandleRequest(ChatMessageReportStatus status, String handlingNote) {
		this(status, ChatMessageReportModerationAction.NONE, handlingNote);
	}
}
