...
- The milestone statement must name the intended PR/review unit, not just the next tiny edit. Example: "This branch is for production deployment config hardening; PR only after cookie, CORS, OAuth redirect, tests, and docs are complete."
